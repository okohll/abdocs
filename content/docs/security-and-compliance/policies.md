...
2) [Continuous archiving ](https://www.postgresql.org/docs/current/warm-standby.html) of the database is also used, to transfer data to a 'hot standby' server using streaming replication, allowing immediate failover should the primary database fail for any reason.
